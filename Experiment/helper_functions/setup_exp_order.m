...
%     
   %bec changed to balance trials - doesn't work for more than 1 stimulus 
    stim_per_block = n.trials * n.sections;
    [R.sigma{k}, R.trial_order{k}] = BalanceTrials(stim_per_block, rand, category_params.test_sigmas, [1:2]);
    R.sigma{k} = reshape(R.sigma{k}, n.sections, n.trials);
    R.trial_order{k} = reshape(R.trial_order{k}, n.sections, n.trials);
