...
source("/Users/s4323621/Dropbox/Documents/EndofDay_Confidence_Models/Quadratic_ModelA/generate_quadratic_parametersA.R")
...
starting_parameters <- foreach(x = 1:n_starting_parameters,
                               .combine = "rbind")  %dopar% {
                                 output = generate_quadratic_parameters()
                               }
toc = Sys.time()
toc - tic
...
source("/Users/s4323621/Dropbox/Documents/EndofDay_Confidence_Models/Quadratic_ModelA/quadratic_model_taskA.R")

tic=Sys.time()
output <- foreach(x = 1:nrow(combinations),
                  .combine = "rbind")  %dopar% {
                    output = quadratic_model_function(combinations[x, 2], #subject_number
...
source("/Users/s4323621/Dropbox/Documents/EndofDay_Confidence_Models/Quadratic_ModelA/simulate_quadratic_data_taskA.R")
