generate_bayesian_parameters_exp <- function(modality = 'visual') {
  #============= Parameter Sampling ===========
  nparams = 8
  ...
  #boundary parameters
  boundaries_mu = c(0.1978161, 0.2689414, 0.3543437, 0.4501660)
  boundaries_sd = rep(0.5, 4)
