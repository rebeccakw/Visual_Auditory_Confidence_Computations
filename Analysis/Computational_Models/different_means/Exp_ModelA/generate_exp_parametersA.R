generate_exp_parameters <- function() {
  ...
  repeat {    
    ...
    rel1 = c(-(kbounds[1:3] + (mbounds[1:3]*(sigmas[1]^exp))), (kbounds[4] + (mbounds[4]*(sigmas[1]^exp))), rev(kbounds[1:3] + (mbounds[1:3]*(sigmas[1]^exp))))
    rel2 = c(-(kbounds[1:3] + (mbounds[1:3]*(sigmas[2]^exp))), (kbounds[4] + (mbounds[4]*(sigmas[2]^exp))), rev(kbounds[1:3] + (mbounds[1:3]*(sigmas[2]^exp))))
    rel3 = c(-(kbounds[1:3] + (mbounds[1:3]*(sigmas[3]^exp))), (kbounds[4] + (mbounds[4]*(sigmas[3]^exp))), rev(kbounds[1:3] + (mbounds[1:3]*(sigmas[3]^exp))))
    rel4 = c(-(kbounds[1:3] + (mbounds[1:3]*(sigmas[4]^exp))), (kbounds[4] + (mbounds[4]*(sigmas[4]^exp))), rev(kbounds[1:3] + (mbounds[1:3]*(sigmas[4]^exp))))
  ...
  if (time_out == TRUE) {
    ...
    generating_parameters <- c(kbounds, mbounds, sigmas, exp)
  }
