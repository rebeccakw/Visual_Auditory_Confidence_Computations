...
source("/Users/rebeccawest/Dropbox/Documents/EndofDay_Confidence_Models/Exp_ModelA/generate_exp_parametersA_cofscaler.R")
...
source("/Users/rebeccawest/Dropbox/Documents/EndofDay_Confidence_Models/Exp_ModelA/exp_model_taskA_cofscaler.R")
...
source("/Users/rebeccawest/Dropbox/Documents/EndofDay_Confidence_Models/Exp_ModelA/simulate_exp_data_taskA_cofscaler.R")
...
simulated_data <- foreach(sub = 1:8,
                          .combine = "rbind")  %dopar% {
                            output = simulate(sub, as.numeric(best_fits[sub, 1:14]))
                          }
toc=Sys.time()
print(toc-tic)
