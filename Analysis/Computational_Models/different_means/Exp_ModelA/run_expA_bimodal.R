...
source("/Users/rebeccawest/Dropbox/Documents/EndofDay_Confidence_Models/Exp_ModelA/exp_model_taskA_bimodal.R")
...
source("/Users/s4323621/Dropbox/Documents/EndofDay_Confidence_Models/Exp_ModelA/simulate_exp_data_taskA_bimodal.R")
best_fits <- read.csv('/Users/s4323621/Dropbox/Documents/Best_Fitting_Parameters/TaskA/Bimodal/bimodal.csv')

tic=Sys.time()
print("running loops")
simulated_data <- foreach(sub = 1:8,
                          .combine = "rbind")  %dopar% {
                            output = simulate_bimodal(sub, as.numeric(best_fits[sub, 1:13]))
                          }
toc=Sys.time()
print(toc-tic)
