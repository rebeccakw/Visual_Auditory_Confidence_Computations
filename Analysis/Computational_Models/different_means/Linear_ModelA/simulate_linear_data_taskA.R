simulate <- function (sub, parameters, modality = 'visual') {
  ...
  rel1 = c(-(parameters[1:3] + (parameters[5:7]*parameters[9])), (parameters[4] + parameters[8]*parameters[9]), rev(parameters[1:3] + (parameters[5:7]*parameters[9])))
  rel2 = c(-(parameters[1:3] + (parameters[5:7]*parameters[10])), (parameters[4] + parameters[8]*parameters[10]), rev(parameters[1:3] + (parameters[5:7]*parameters[10])))
  rel3 = c(-(parameters[1:3] + (parameters[5:7]*parameters[11])), (parameters[4] + parameters[8]*parameters[11]), rev(parameters[1:3] + (parameters[5:7]*parameters[11])))
  rel4 = c(-(parameters[1:3] + (parameters[5:7]*parameters[12])), (parameters[4] + parameters[8]*parameters[12]), rev(parameters[1:3] + (parameters[5:7]*parameters[12])))
