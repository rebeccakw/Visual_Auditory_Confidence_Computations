...
##=========== Define Parameters ====================
source("/Users/s4323621/Dropbox/Documents/multimodal_confidence/bayesian_model_odn/generate_bayesian_parameters_odn.R")
...
starting_parameters <- foreach(sub = 1:n_starting_parameters,
                               .combine = "rbind")  %dopar% {
                                 output = generate_bayesian_parameters_odn(inital_starting_parameters, 
                                                                           rep(1, 12), confidencedata, 'visual')
                               }
toc = Sys.time()
toc - tic
beep()
...
#}
##============= Simulate Data =====================
source("/Users/s4323621/Dropbox/Documents/multimodal_confidence/bayesian_model_odn/simulate_bayesian_data_odn.R")
...
##================ Fit Model to Data ==================
source("/Users/s4323621/Dropbox/Documents/multimodal_confidence/bayesian_model_odn/bayesian_model_odn.R")
n_parameters = ncol(starting_parameters)
 print("running loops")
output <- foreach(x = 1:nrow(combinations),
                  .combine = "rbind")  %dopar% {
                    output = bayesian_model_odn(simulated_data[simulated_data$simulation_set == x,], 
...
write.csv(parameter_recovery, "/Users/s4323621/Dropbox/Documents/multimodal_confidence/recovery_data/bayesian_odn_720*2_cleaned.csv")
